...
class CreateNeweventTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('newevent', function (Blueprint $table) {
    ...
    {
        Schema::table('newevent', function ($table) {
            $table->dropForeign('newevent_user_id_foreign');
        });
        Schema::dropIfExists('newevent');
    }
}
